...
function loadProfile() {
  ...
  try { const s = localStorage.getItem("francesca_profile"); return s ? JSON.parse(s) : DEFAULT_PROFILE; } catch { return DEFAULT_PROFILE; }
}
...
export default function CashflowPage() {
  ...
  // Federal pretax includes HSA; CA pretax does not (CA doesn't allow HSA deduction)
  ...
  return (
    <>
      <Nav />
      <main style={{ maxWidth: 760, margin: "0 auto", padding: "68px 24px 40px" }}>
