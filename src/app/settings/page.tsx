...
export default function SettingsPage() {
  ...
  return (
    <>
      <Nav />
      <main style={{ maxWidth: 640, margin: "0 auto", padding: "68px 24px 60px" }}>
        ...
        <div className="fade-up delay-1">
          ...
          <div className="glass" style={{ padding: "4px 20px 4px" }}>
            ...
            <Field label="RSU Value" note="Current holding value — held forever"><NumInput value={p.rsuValue} onChange={(v) => update("rsuValue", v)} step={1000} /></Field>
          </div>
          ...
          <div className="glass" style={{ padding: "4px 20px 4px", marginTop: 12 }}>
            ...
            <Field label="Other Expenses" note="Single bucket — food, transport, subscriptions…"><NumInput value={p.otherExpenses} onChange={(v) => update("otherExpenses", v)} /></Field>
          </div>
          ...
          <div className="glass" style={{ padding: "4px 20px 4px", marginTop: 12 }}>
            ...
            <Field label="Brokerage Tax Drag" note="Effective annual drag from dividends + realized gains"><PctInput value={p.brokerageTaxDrag} onChange={(v) => update("brokerageTaxDrag", v)} /></Field>
